  ...
  return (
    ...
    >
      ...
      <div
       ...
       shadow md:flex-row max-w-3xl bg-transparent border-none
        cursor-pointer   py-5 px-5"
      >
        <div className="max-w-xs md:m-0 mx-auto w-full">
          <img
        ...
        <div className="flex w flex-col p-4 leading-normal max-w-5xl md:m-0 mx-auto">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white max-w-5xl">
