    ...
    <div className="mx-[10rem]">
      ...
      <div className="flex max-w-[100%] gap-10 items-center">
        ...
        <div className=" flex hover:transform hover:scale-105 cursor-pointer duration-500	">
          ...
          <div className=" rounded z-10 absolute w-[27rem]">
            <img
      ...
      <div className="flex max-w-[100%] gap-10 items-center mt-14 flex-row-reverse">
        ...
        <div className=" flex hover:transform hover:scale-105 cursor-pointer duration-500	">
          ...
          <div className=" rounded z-10 absolute w-[27rem]">
            <img
              src="https://www.brajsundar.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimage2.77695b97.jpg&w=1080&q=75"
              alt=""
              className="rounded-xl "
            />
          </div>
      ...
      <div className="flex max-w-[100%] gap-10 items-center mt-14 ">
        ...
        <div className=" flex hover:transform hover:scale-105 cursor-pointer duration-500	">
          <div className="flex rounded-xl w-[23rem] mt-4 bg-white/15 ml-4 h-[15.5rem] border-4 border-white/50 "></div>
          <div className=" rounded z-10 absolute w-[23rem]">
            <img
              src="https://www.brajsundar.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimage3.7254ed2e.jpg&w=640&q=75"
              alt=""
              className="rounded-xl "
            />
          </div>
      ...
      <div className="flex max-w-[100%] gap-10 items-center mt-14 flex-row-reverse">
        <div className="max-w-[60%] ">
          ...
          <p className="text-lg">
            ...
            4756+ devotees through his Bhāgavata Teachers Training course. He
            serves as an editor of the E-Magazine 'Nityam Bhagavata Sevaya,'
        ...
        <div className=" flex hover:transform hover:scale-105 cursor-pointer duration-500	">
          ...
          <div className=" rounded z-10 absolute w-[27rem]">
            <img
              src="https://www.brajsundar.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FnewImage1.e0bfd611.jpg&w=640&q=75"
              alt=""
              className="rounded-xl "
            />
          </div>
