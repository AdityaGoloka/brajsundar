    ...
    return (
        <div className='border border-blue-400'>
            ...
            <div className="w-full h-full">
                <img src='./event-bg.jpg' alt='brajsundardas' />
            </div>
            ...
            <div className="border border-red-600">
                ...
                <button
                    type='button'
                    className="border border-violet-500 flex justify-center items-center bg-blue-400 m-auto w-fit px-14 py-5 text-black hover:bg-blue-600 cursor-pointer font-bold text-lg "
                ...
                {formModal && (
                    <div className="fixed inset-0 bg-gray-700 bg-opacity-50 flex items-center justify-center">
                        <div className="bg-white p-6 rounded-lg overflow-auto max-h-full">
                            <h1 className='text-black mb-4'>BOOK BrajSundarDas
                                <br />
